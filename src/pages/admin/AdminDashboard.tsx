  ...
  return (
    <div className="flex h-screen">
      ...
      <div className="flex flex-col w-full">
        <AdminHeader />
        <div className="p-6">
          <h1 className="text-2xl font-bold mb-4 text-fuchsia-800">Dashboard</h1>
          <div className="grid grid-cols-3 gap-6">
            {/* Card 1: Doctors Count */}
            <div className="bg-white shadow-md rounded-lg p-6 text-fuchsia-800">
          ...
          {/* Placeholder Graph */}
          <div className="bg-white shadow-md rounded-lg p-6 mt-6 text-fuchsia-800">
